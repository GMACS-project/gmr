...
Working with A Generalized size-structured Model for Assessing Crustaceans.

`gmr` is an R package providing tools to work with *[GMACS]*, a generalized size-structured assessment model for Crustaceans. Specifically, it includes an extensive library of functions to plot outputs of the model.
